...
public interface ConfigurableListableBeanFactory
	...
	/**
	 * 清除不能缓存的 BeanDefinition，当 configurationFrozen=true 时可以缓存
	...
	/**
	 * configurationFrozen=true 时缓存 BeanDefinition 信息
